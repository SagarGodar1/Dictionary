...
public class AdminFoodListAdapter extends RecyclerView.Adapter<AdminFoodListAdapter.Holder> {

    private Context context;
    private List<Food> foodList;

    public AdminFoodListAdapter(Context context, List<Food> foodList) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        ...
        holder.btnDelete.setOnClickListener(v -> {
            FoodBLL bll = new FoodBLL(food.getId(), food.getName(), food.getCategory(), food.getPrice(), food.getImage());
            if (bll.deleteFood()) {
